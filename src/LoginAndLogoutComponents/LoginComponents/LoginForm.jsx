  ...
  const handleSubmit = (e) => {
    ...
    dispatch(
      ...
      if (signInUser.fulfilled.match(result)) {
        //Alternatively, you can write if (result.type === 'auth/signInUser/fulfilled')
        console.log("User signed in successfully:", result.payload);
      } else {
        console.error("Failed to sign in:", result.payload);
      }
    });
  };

...
import ProductDetailsButton from "../../Reuseable-Components/ProductDetailsButton/ProductDetailsButton";
...
const ProductPageUI = ({ product }) => {
  return (
    <div className="max-w-xs w-full mx-auto flex flex-col h-full">
      <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden flex flex-col h-full">
      ...
      <ProductDetailsButton className="mt-5" product={product} />

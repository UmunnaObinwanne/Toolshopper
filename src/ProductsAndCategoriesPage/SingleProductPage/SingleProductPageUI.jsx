          ...
          <div className="max-w-xl">
            ...
            <div className="mt-8">
              <ul className="flex border-b">
                <li
                  className={`text-sm py-3 px-8 cursor-pointer transition-all ${
                    selectedTab === "description"
                      ? "text-gray-800 font-bold bg-gray-100 border-b-2 border-gray-800"
                ...
                <div className="mt-8">
                  ...
                  <div className="text-sm text-gray-600 mt-4">
                    ...
                    <p>
                      ...
                      vestibulum a turpis in lacinia.
                    </p>
                  </div>
                </div>
              )}
...
export default SingleProductPageUI;

...
const FeaturesSection = () => {
  return (
    <div className="bg-[#F7F7F7] text-[#333] font-[sans-serif] py-16">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-4xl font-extrabold text-center mb-12">
          Our Competitive Advantage
        </h2>
        <div className="flex flex-wrap justify-center items-stretch gap-4">
          <div className="bg-white rounded-lg overflow-hidden shadow-lg flex-1 min-w-[200px] max-w-[300px]">
            <div className="p-4">
              <svg
              ...
              <p className="text-gray-500 text-sm">
                On all orders. Just buy what you want, and we handle the fast
                shipping for you
              </p>
            </div>
          </div>
          <div className="bg-white rounded-lg overflow-hidden shadow-lg flex-1 min-w-[200px] max-w-[300px]">
            <div className="p-4">
              ...
              <h3 className="text-lg font-semibold mb-2">15 Days Return</h3>
              <p className="text-gray-500 text-sm">
                You no longer fancy what you bought? Send us an email, and we
                will process returns and refunds
              </p>
            </div>
          </div>
          <div className="bg-white rounded-lg overflow-hidden shadow-lg flex-1 min-w-[200px] max-w-[300px]">
            <div className="p-4">
              ...
              <p className="text-gray-500 text-sm">
                100% protected by PayPal and Back by World Bank
              </p>
            </div>
          </div>
          <div className="bg-white rounded-lg overflow-hidden shadow-lg flex-1 min-w-[200px] max-w-[300px]">
            <div className="p-4">
              ...
              <h3 className="text-lg font-semibold mb-2">100% Free Warranty</h3>
              <p className="text-gray-500 text-sm">Moneyback guarantee</p>
            </div>
          </div>
        </div>
      </div>
